...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Contact Us</h1>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600 mb-2">For customer service:</p>
                <a href="mailto:support@zplus.com" class="text-blue-600 hover:underline">support@zplus.com</a>
                <p class="text-gray-600 mt-2 mb-2">For business inquiries:</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <p class="text-gray-600 mb-2">Customer support:</p>
                <a href="tel:+1-800-123-4567" class="text-blue-600 hover:underline">+1 (800) 123-4567</a>
                <p class="text-gray-600 mt-2 mb-2">Hours:</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">Location</h3>
