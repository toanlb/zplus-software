...
@section('content')
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 mb-10 lg:mb-0">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">{{ __('home.hero_title') }}</h1>
                    <p class="text-xl mb-8 text-blue-100">{{ __('home.hero_subtitle') }}</p>
                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="{{ route('products.index') }}" class="bg-white text-blue-600 hover:bg-gray-100 font-semibold rounded-md px-6 py-3 text-center transition-all duration-200">{{ __('home.hero_cta') }}</a>
                        <a href="{{ route('contact') }}" class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 text-white font-semibold rounded-md px-6 py-3 text-center transition-all duration-200">{{ __('general.contact') }}</a>
                    </div>
                </div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold mb-4">{{ __('home.products_title') }}</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">{{ __('home.products_subtitle') }}</p>
            </div>
    ...
    <section class="bg-gray-100 py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold mb-4">{{ __('home.features_title') }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <h3 class="text-xl font-bold mb-3">{{ __('home.feature_1_title') }}</h3>
                    <p class="text-gray-600">{{ __('home.feature_1_desc') }}</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <h3 class="text-xl font-bold mb-3">{{ __('home.feature_2_title') }}</h3>
                    <p class="text-gray-600">{{ __('home.feature_2_desc') }}</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <h3 class="text-xl font-bold mb-3">{{ __('home.feature_3_title') }}</h3>
                    <p class="text-gray-600">{{ __('home.feature_3_desc') }}</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <h3 class="text-xl font-bold mb-3">{{ __('home.feature_4_title') }}</h3>
                    <p class="text-gray-600">{{ __('home.feature_4_desc') }}</p>
                </div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold mb-4">{{ __('home.projects_title') }}</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">{{ __('home.projects_subtitle') }}</p>
            </div>
    ...
    <section class="bg-blue-600 py-16 text-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-blue-100 max-w-2xl mx-auto">{{ __('home.testimonials_subtitle') }}</p>
            </div>
    ...
    <section class="py-20">
        <div class="container mx-auto px-4">
            <div class="bg-gray-900 rounded-xl text-white text-center p-12">
                ...
                <p class="text-gray-300 max-w-2xl mx-auto mb-8">{{ __('home.newsletter_subtitle') }}</p>
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('products.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md px-8 py-3 transition-all duration-200">{{ __('home.hero_cta') }}</a>
                    <a href="{{ route('contact') }}" class="bg-white text-blue-600 hover:bg-gray-100 font-semibold rounded-md px-8 py-3 transition-all duration-200">{{ __('general.contact') }}</a>
                </div>
            </div>
        </div>
    </section>
